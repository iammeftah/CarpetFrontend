...
const CartSidebar: React.FC<CartSidebarProps> = ({ isOpen, onClose, products }) => {
    ...
    return (
        <div className={`fixed top-0 right-0 h-full w-full md:w-1/4 bg-white dark:bg-black shadow-lg transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out overflow-y-auto`}>
            <div className="p-6">
